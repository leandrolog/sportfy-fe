    ...
    return (
        <div style={{ justifyContent: "center", display: "flex", alignItems: "center", paddingTop: "7rem", flexDirection: 'column' }}>
            ...
            <div style={{ display: "flex", paddingTop: "2rem", alignItems: 'center' }}>
                <div style={{ width: "150px", height: "150px", borderRadius: "50%", overflow: "hidden", marginRight: "2rem", backgroundColor: "#ccc" }}>
                    <img src={ProfileImage} alt="Imagem de Perfil" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
